...
SET_ENV_VARS="${SET_ENV_VARS}@DEFAULT_TENANT_ID=${DEFAULT_TENANT_ID:-plasyect_matriz}@BIGZAP_BATCH_LIMIT=${BIGZAP_BATCH_LIMIT:-800}@BIGZAP_ACTIVE_DAYS=${BIGZAP_ACTIVE_DAYS:-30}@BIGZAP_PLANT_ACTIVE_DAYS=${BIGZAP_PLANT_ACTIVE_DAYS:-55}@PGSSL=${PGSSL:-true}"
